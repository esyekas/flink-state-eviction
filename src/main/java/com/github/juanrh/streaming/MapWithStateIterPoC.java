...
public class MapWithStateIterPoC {
    ...
    final Logger LOG = LoggerFactory.getLogger(MapWithStateIterPoC.class);
    ...
    public static void main(String [] args) throws Exception {
        ...
        SourceFunction<Tuple2<String, Integer>> source =
                ElementsWithGapsSource
                        ...
                        .addElem(Tuple2.of("b", 1))//.addGap(Time.seconds(500)) // FIXME uncommenting this the program blocks for reasons unknown
        ...
        final Time ttl = Time.milliseconds(1500);
